...
<head>
  ...
  <link href="<?php echo $CONFIG['home_http']?>theme/assets/<?php echo $CONFIG['asset']?>/css/vendor/all.css" rel="stylesheet">
      ...
      <div class="lock-container">
        ...
        <div class="panel panel-default text-center">
          ...
          <div class="panel-body">
            ...
            <a href="javascript:;" onClick="$('#form').submit();" class="btn btn-primary">Login <i class="fa fa-fw fa-unlock-alt"></i></a>
